...
const Sidebar = () => {
  return (
    <div className="flex justify-between pl-4 pr-4 text-white text-sm items-center md:flex-col md:pl-0 md:pr-0 md:p-4">
      <Link href="/" passHref>
        <div className="flex flex-col items-center justify-center mb-0 md:mb-6 fill-gray-400 active:bg-purple-400 active:fill-purple-800 active:stroke-purple-800 rounded-lg">
      ...
      <Link href="/search" passHref>
        <div className="flex flex-col items-center justify-center mb-0 md:mb-6 active:bg-purple-400 active:fill-purple-800 active:stroke-purple-800 rounded-lg">
