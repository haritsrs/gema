        ...
        return (
          <div className="p-2 bg-green-500 bg-opacity-20 rounded-full">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-green-500" viewBox="0 0 24 24">
              <path  d="M12 12c2.76 0 5-2.24 5-5s-2.24-5-5-5s-5 2.24-5 5s2.24 5 5 5m0-8c1.66 0 3 1.34 3 3s-1.34 3-3 3s-3-1.34-3-3s1.34-3 3-3m0 10c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4m0 2c2.67 0 6 1.34 6 2h-12c0-.66 3.33-2 6-2" />
            </svg>
          </div>
        );
      case 'mention':
