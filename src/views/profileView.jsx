      ...
      <div className="max-w-2xl mx-auto px-4 mt-8">
          ...
          <div className="bg-gradient-to-br from-gray-900/40 to-gray-800/40 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl p-6 relative">
            <div className="grid grid-cols-3 gap-4 items-center">
              <div className="col-span-1 flex flex-col items-start">
                <div className="text-sm font-medium text-white mb-1">Likes</div>
              ...
              <div className="col-span-1 flex flex-col items-center">
                <div className="text-sm font-medium text-white mb-1">Posts</div>
                <div className="text-2xl text-white">{userPosts.length}</div>
              </div>
              ...
              <div className="flex flex-col space-y-2">
                ...
                >
                  <div className="text-sm font-medium text-white">Followers</div>
                  <div className="text-xl text-white">{followers.length}</div>
                </button>
                <button
                  onClick={() => setShowFollowingModal(true)}
                  className="flex items-center space-x-2 hover:bg-gray-800 rounded-lg p-2 transition-colors"
                >
                  <div className="text-sm font-medium text-white">Following</div>
                  <div className="text-xl text-white">{following.length}</div>
                </button>
              </div>
        ...
        {userPosts.length === 0 ? (
          ...
          <ul className="space-y-4">
            {userPosts.map((post) => (
              <li key={post.id || `post-${Date.now()}-${Math.random()}`} 
                  className="text-white p-4 bg-gradient-to-br from-purple-900/10 via-gray-800/20 to-blue-900/10 backdrop-blur-sm border border-white/10 rounded-2xl shadow-xl hover:from-purple-900/15 hover:via-gray-800/25 hover:to-blue-900/15 transition-all duration-300 ease-in-out relative overflow-hidden">
